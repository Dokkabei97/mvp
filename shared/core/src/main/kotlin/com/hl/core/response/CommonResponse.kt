...
class CommonResponse<T>(
    ...
    companion object {
        fun <T> success(
            data: T,
            message: String?,
        ): CommonResponse<T> = CommonResponse(Result.SUCCESS, data, message, null)
        ...
        fun fail(
            message: String?,
            errorCode: String?,
        ): CommonResponse<*> = CommonResponse(Result.FAIL, null, message, errorCode)
        ...
        fun <T> fail(
            ...
            message: String?,
            errorCode: String?,
        ): CommonResponse<T> = CommonResponse(Result.FAIL, data, message, errorCode)
    }
}
